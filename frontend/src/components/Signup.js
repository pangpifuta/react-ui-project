...
export default class Signup extends Component {
    ...
    renderSignupButton() {
      return (
        < Button primary icon={< Signin />} label="Sign Up" onClick={this.onLogin} />  /*implements more on save data on database here*/
      );
    }
      ...
      validateField(fieldName, value) {
        ...
        switch(fieldName) {
          ...
          case 'password':
            ...
            fieldValidationErrors.password = passwordValid ? '': ' must be more than 6 characters';
            break;
          case 'confirmpassword':
            passwordValid = value.match(this.state.password) ;
            fieldValidationErrors.password = passwordValid ? '': ' confirmation fails';
            break;  
          default:
            break;
        }
          ...
          <Box responsive={false} pad='medium' style={{ width: 350 }} elevation='medium' background="white" animation='fadeIn'>
            ...
            <FormField label="Password">
              <TextInput
                ...
                <TextInput placeholder=" " 
                type="password" required className="form-control" name="confirmpassword"
