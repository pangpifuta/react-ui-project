    ...
    if (numWidgets > 0) {
      ...
      decorations = React.createElement(
        ...
        widgets.map(function (widget, index) {
          return React.createElement(Button, _extends({ disabled: disabled, tabIndex: '-1', key: 'widget_' + index }, widget));
        }),
        drop
      );
    }
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          null,
          function (theme) {
            return React.createElement(StyledDropInput, _extends({
              ref: function ref(_ref) {
                _this2.inputControlRef = _ref && findDOMNode(_ref);
              },
              theme: theme,
              disabled: disabled,
