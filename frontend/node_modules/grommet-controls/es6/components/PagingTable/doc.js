...
export default (function (Element) {
  var DocumentedElement = describe(Element).description('A Grommet 2 table component with pagination, filtering, footer, child rows and grouping. Derived from https://github.com/react-tools/react-table. ').usage('\n    $ npm install grommet-controls\n\n    import { PagingTable } from \'grommet-controls\';\n\n    <PagingTable columns={...} data={...} />\n');
  ...
  DocumentedElement.propTypes = {
    ...
    columns: PropTypes.arrayOf(PropTypes.shape({
      Cell: PropTypes.oneOfType([PropTypes.element, PropTypes.string, PropTypes.func]).description('Used to render a standard cell, defaults to the accessed value.'),
      Header: PropTypes.oneOfType([PropTypes.element, PropTypes.string, PropTypes.func]).description('Used to render the header of a column or column group.'),
