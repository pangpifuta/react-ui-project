...
var Sidebar = function (_React$Component) {
  ...
  Sidebar.prototype.render = function render() {
    ...
    var BtnToggle = function BtnToggle(_ref) {
      var view = _ref.view;
      return collapsible ? React.createElement(Button, { icon: React.createElement(Menu, null), onClick: function onClick() {
    ...
    return React.createElement(
      ...
      null,
      function (size) {
        return collapsible && size === 'small' && collapsed === undefined || collapsed === true ? React.createElement(
          Box,
          { align: 'start' },
          React.createElement(BtnToggle, { view: 'collapsed' })
        ) : React.createElement(
          Box,
          _extends({
            width: width
